...
module.exports = {
    ...
    run: async(client, message, args) => {
        ...
        let embed = new MessageEmbed()
            ...
            .addField('Games System 🎮', '`aki`, `brand`, `capitals`, `coinflip`, `cut`, `emojis`, `fast`, `fkk`, `flags`, `fruits`, `hack`, `hug`, `kill`, `kiss`, `love`, `math`, `puzzle`, `sara7a`, `sui`, `translate`, `trash`, `5od`, `drake`, `slap`, `points`, `games-leaderboard`, `triggered`, `bed`, `delete`, `egg`')
